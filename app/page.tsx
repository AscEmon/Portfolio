...
//   const skills = [
//     { category: "Mobile Frameworks", items: ["Flutter", "SwiftUI", "Android", "MERN"] },
//     { category: "Programming Languages", items: ["Dart", "Javascript", "Kotlin", "Swift", "Python"] },
//     { category: "State Management", items: ["Riverpod", "Bloc", "GetX", "Provider"] },
//     { category: "Databases", items: ["MongoDB", "SQLite", "Hive", "Firebase", "ObjectBox"] },
//     { category: "CI/CD & DevOps", items: ["GitHub Actions", "Bitbucket Pipelines", "Codemagic", "Jenkins"] },
//     { category: "AI IDE & Tools", items: ["Claude Desktop","Claude Code", "Google Antigravity", "Cursor", "v0", "MCP", "NoteBookLLM", "Gamma"] },
//   ]
...
//               6+ years of Flutter expertise • 20+ successful mobile apps • Technical mentor
//             </p>
...
//                 Passionate Senior Software Specialist with 6+ years of expertise in Flutter development, mobile app
