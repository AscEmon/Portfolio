...
export default function Portfolio() {
  ...
  const skills: SkillGroup[] = [
    { category: "Mobile Frameworks", items: ["Flutter", "SwiftUI", "MERN"] },
    { category: "Programming Languages", items: ["Dart", "JavaScript", "Swift", "Python", "Java", "Node.js"] },
    { category: "State Management", items: ["Riverpod", "BLoC", "GetX", "Provider"] },
    { category: "Backend & APIs", items: ["REST API", "GraphQL", "Firebase", "Node.js"] },
